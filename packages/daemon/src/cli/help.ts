...
const commandHelp: Record<Subcommand, string[]> = {
  ...
  model: [
    ...
    '',
    bold('Usage:'),
    entry('remi model ls', 'Catalogue: id, size, resident state'),
    ...
    entry('remi model pull <id>', 'Download + load a model, with progress'),
    ...
    dim('  A first pull downloads several GB from HuggingFace; progress is shown.'),
